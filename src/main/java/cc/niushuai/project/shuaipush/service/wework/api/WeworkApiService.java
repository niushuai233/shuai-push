...
public class WeworkApiService {
    ...
    public String getToken() {
        ...
        // 重新 放入缓存
        CacheManager.getDefault().put(Keys.WEWORK_ACCESS_TOKEN, weworkResp.getAccessToken(), weworkResp.getExpiresIn() * 1000L);
    ...
    public void sendAppMessage(MessageVO message) {
        ...
        WeworkAppMessage weworkAppMessage = new WeworkAppMessage()
                ...
                .setAgentId(pushConfig.getWework().getAppId())
                .setSafe(0L)
                .setEnableIdTrans(0L)
        ...
        WeworkResp weworkResp = RestTemplateUtil.postJson(ApiConstant.constructWeworkUrl(Message.Send, getToken()), weworkAppMessage, WeworkResp.class);
